...
This section summarizes the small number of strategic decisions that shape the platform foundation architecture. The detailed structure appears in <<section-building-block-view,Section 5>>, the behavior in <<section-runtime-view,Section 6>>, and the cross-cutting rules in <<section-concepts,Section 8>>.
