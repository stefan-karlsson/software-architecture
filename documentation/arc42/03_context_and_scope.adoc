...
The next concrete interface and trust decisions are tracked in link:../adrs/0008-select-platform-access-interface-and-automation-protocol-profile.adoc[ADR 0008] for the public access protocol profile, link:../adrs/0009-select-identity-federation-and-service-account-credential-model.adoc[ADR 0009] for identity federation plus service-account credentials, and link:../adrs/0013-adopt-multi-surface-browser-architecture-with-thin-shells-remotes-and-shared-contracts.adoc[ADR 0013] for browser-application composition.
