...
|User journeys enter through the in-scope browser containers at `www.example.com`, `app.example.com`, `admin.example.com`, and `login.example.com`, as defined by link:../adrs/0013-adopt-multi-surface-browser-architecture-with-thin-shells-remotes-and-shared-browser-foundations.adoc[ADR 0013].
