...
The next concrete interface and trust decisions are tracked in ADR 0008 for the public access protocol profile and ADR 0009 for identity federation plus service-account credentials.
