...
|A-04
|Resolve the authoritative audit store and evidence export technology profile.
|link:../adrs/0010-select-authoritative-audit-store-and-evidence-export-technology-profile.adoc[ADR 0010], Sections 7, 8, and 10
