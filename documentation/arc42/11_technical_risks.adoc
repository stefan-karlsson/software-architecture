...
|A-02
|Apply the accepted audit evidence architecture to runtime examples, storage decisions, and future platform tests.
|ADR 0005, Sections 5, 7, and 10
|The accepted audit model is reflected consistently in architecture examples today and is ready to drive later implementation decisions and tests.

|A-03
|Apply the accepted ownership and consistency model to future persistence, integration, and test decisions.
|ADR 0006, Sections 5, 6, 7, and 8
|The accepted ownership model is reflected consistently in architecture examples today and is ready to drive later implementation decisions and tests.

|A-04
|Apply the accepted hybrid isolation model to runtime examples, placement decisions, and future platform tests.
|ADR 0007, Sections 6, 7, and 10
|The accepted hybrid model is reflected consistently in architecture examples today and is ready to drive later implementation decisions and tests.
