...
link:../adrs/0013-adopt-multi-surface-browser-architecture-with-thin-shells-remotes-and-shared-browser-foundations.adoc[ADR 0013] defines the accepted browser-composition baseline for these surfaces, remotes, and shared browser foundations.
...
link:../adrs/0012-select-runtime-topology-and-network-isolation-implementation-profile.adoc[ADR 0012] defines the accepted hosting direction for that model: environments are placed in shared or dedicated runtime cells under one policy-governed hierarchy, and dedicated network outcomes must use stronger boundaries than namespace-only separation.
