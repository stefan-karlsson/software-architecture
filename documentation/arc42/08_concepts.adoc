...
Concrete public interface and credential decisions for those actors are tracked separately in link:../adrs/0008-select-platform-access-interface-and-automation-protocol-profile.adoc[ADR 0008] and link:../adrs/0009-select-identity-federation-and-service-account-credential-model.adoc[ADR 0009].
...
The next concrete implementation decision for authoritative audit storage and evidence export is tracked in link:../adrs/0010-select-authoritative-audit-store-and-evidence-export-technology-profile.adoc[ADR 0010].
