...
|Audit Evidence
|Owns authoritative audit evidence, preserves scope and decision context, enforces governance-oriented audit behavior, and exports operational telemetry as a secondary concern.
...
|Policy decisions and policy changes must be preserved as authoritative audit evidence at the correct scope.
...
|Privileged and regulated events must preserve actor, scope, and decision context in authoritative audit evidence, while telemetry export remains a secondary downstream concern.
|===
