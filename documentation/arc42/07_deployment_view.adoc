...
The next concrete implementation-profile decisions are tracked in ADR 0010 for canonical audit storage and export, ADR 0011 for owner-state integration and projections, and ADR 0012 for runtime topology plus network isolation.
