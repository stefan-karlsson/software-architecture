...
link:../adrs/0010-select-authoritative-audit-store-and-evidence-export-technology-profile.adoc[ADR 0010] defines the accepted audit storage and export direction. link:../adrs/0011-select-owner-managed-state-integration-and-projection-technology-profile.adoc[ADR 0011] defines the accepted owner-managed state propagation and projection pattern. The remaining concrete implementation-profile decision is tracked in link:../adrs/0012-select-runtime-topology-and-network-isolation-implementation-profile.adoc[ADR 0012] for runtime topology plus network isolation.
